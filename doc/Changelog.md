...
Updated
- เพิ่มปุ่มให้ผู้ใช้เลือกข้อมูลที่ต้องการ Backup ได้ ในหน้า "ลบข้อมูลบัญชี"
- ผู้ใช้ที่ไม่มีข้อมูลชนิดนั้นไม่สามารถติ๊กได้
...
Added
- เพิ่มคอลัมน์ API
- เพิ่ม UI รูปโล่ที่สามารถไว้ดูค่า Hash

Security Improvements
- เพิ่มการ Hash แบบ Blockchain เพื่อป้องกันการแก้ไข Log จากผู้ดูแล
