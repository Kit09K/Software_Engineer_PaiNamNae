...
const exportLogs = asyncHandler(async (req, res) => {
    ...
    const logs = await systemLogService.exportLogsToJSON(filter);

    // สร้าง Log เพื่อบันทึกว่า Admin คนไหนทำการ Export ข้อมูล (เพื่อความปลอดภัย)
    await systemLogService.createLog({
        ...
        details: { message: 'Admin exported system logs', filterUsed: filter }
    });
